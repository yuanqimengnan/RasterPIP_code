...
void GLTextureBuffer::create(int size, GLenum format, void* data)
{
    ...
    glBufferStorage(GL_SHADER_STORAGE_BUFFER, size*5, data, GL_MAP_PERSISTENT_BIT | GL_MAP_COHERENT_BIT | GL_MAP_READ_BIT);
   // glBufferData(GL_SHADER_STORAGE_BUFFER, size*5, data, GL_DYNAMIC_DRAW );
    glBindBufferBase(GL_SHADER_STORAGE_BUFFER, 2, ssbo);

    QVector<int> data1(size/sizeof(int));
...
//    std::cout<<"get count:"<<timer1.elapsed()<<std::endl;;
//    timer1.restart();
